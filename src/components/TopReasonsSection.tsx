...
const TopReasonsSection = () => {
    return (
        <section className="w-[95%] mx-auto text-white">
            <div
                className="flex flex-col md:flex-row justify-between gap-12 md:gap-[100px] px-4 md:px-6 pt-5 pb-8 rounded-[40px] border border-dashed border-white/30 max-w-[1200px] mx-auto"
                style={{
            ...
            >
                ...
                {/* Content */}
                <div className="w-full md:w-1/2 md:pl-[33px]">
